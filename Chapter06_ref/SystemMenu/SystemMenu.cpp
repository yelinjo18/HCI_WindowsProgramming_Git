...
// SystemMenu.cpp : 응용 프로그램에 대한 클래스 동작을 정의합니다.
//
...
CSystemMenuApp::CSystemMenuApp()
{
	...
	SetAppID(_T("SystemMenu.AppID.NoVersion"));

	// TODO: 여기에 생성 코드를 추가합니다.
	// InitInstance에 모든 중요한 초기화 작업을 배치합니다.
}

// 유일한 CSystemMenuApp 개체입니다.
...
int CSystemMenuApp::ExitInstance()
{
	//TODO: 추가한 추가 리소스를 처리합니다.
	return CWinApp::ExitInstance();
}

// CSystemMenuApp 메시지 처리기
